# Identifying Influences on the Gap between Parenting Desire and Perceived Likelihood in LGB American Adults with Random Forests

**Please note: This repository will remain empty and missing information will be missing in the README until the research paper is submitted for review. Thank you for your understanding.**

This repository is for the research paper "Identifying Influences on the Gap between Parenting Desire and Perceived Likelihood in LGB American Adults with Random Forests", found at DOI: [UNAVAILABLE]. This repository only contains the code created for our research. Additional materials will need to be obtained from elsewhere.
